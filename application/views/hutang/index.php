        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Data Hutang</p>
                </div>
                                    ...
                                    <table class="table table-striped table-bordered" id="table1">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th rowspan="1" class="text-center">TANGGAL</th>
                                                <th rowspan="1" class="text-center">KETERANGAN</th>
                                                <th colspan="1" class="text-center">NOMINAL</th>
                                                <th rowspan="1" width="12%" class="text-center">OPSI</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-bold-500">Setor</td>
                                                <td class="text-bold-500">Rp. 10,000,000</td>
